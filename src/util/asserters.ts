...
import {type InputProps, type PreviewProps, type SchemaType, isObjectSchemaType} from 'sanity'
...
export function isMuxInputProps(props: InputProps): props is MuxInputProps {
  return isObjectSchemaType(props.schemaType) && props.schemaType.type?.name === 'mux.video'
}
