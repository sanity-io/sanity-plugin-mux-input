...
import {Dispatch, useEffect, useId, useMemo, useReducer, useRef, useState} from 'react'
...
export type UploadConfigurationStateAction =
  ...
  | {action: 'drm_enabled'; value: UploadConfig['drm_enabled']}
  | TrackAction
  ...
  return (
    ...
    >
      <Stack padding={4} space={2}>
        ...
        {!basicConfig && <DrmConfig drmEnabled={config.drm_enabled} dispatch={dispatch} disabled />}
...
const DrmConfig = ({
  ...
  const description = disabled
    ? 'To enable DRM add your DRM Configuration Id to your plugin config. Contact us to get started using DRM.'
    : ''
